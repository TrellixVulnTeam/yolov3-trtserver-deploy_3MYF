...
def detect(save_txt=False, save_img=False):
    ...
    weights = "weights/yolov3-voc_42000.weights"
    # Load weights
    ...
    if ONNX_EXPORT:
        ...
        dummy_imageid = Variable(torch.randn(1, 1)).type(torch.int32)
        dummy_image = Variable(torch.randn(1, 416, 416, 3)).type(torch.float32)

        input_names = ["image"]
        output_names = ["output0", "output1"]
        # input_names = ["imid", "image"]
        # output_names = ["output0", "output1"]
        ...
        torch.onnx.export(model,
                          dummy_image,
                          'weights/export.onnx',
                          dynamic_axes={"image": {0: "batch"}, "output0": {0: "batch"}, "output1": {0: "batch"}},
