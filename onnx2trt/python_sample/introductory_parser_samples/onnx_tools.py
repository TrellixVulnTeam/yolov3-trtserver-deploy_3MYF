...
def main():
    ...
    parser.add_argument("--onnx", required=False, default="/workspace/tensorrt/data/yolov3/tools_yolov3.onnx", help="The ONNX model file to convert to TensorRT")
    ...
    with trt.Builder(TRT_LOGGER) as builder, \
        ...
        if args.nms:
            ...
            scores_reshape_op.reshape_dims = [-1, 10647, 19]
