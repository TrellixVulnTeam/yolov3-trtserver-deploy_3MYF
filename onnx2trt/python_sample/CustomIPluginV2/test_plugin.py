...
if __name__ == '__main__':
    ...
    plugin_library = os.path.join("/opt/tensorrt/samples/python/CustomIPluginV2", "CustomPlugin.so")
    ...
    with trt.Builder(TRT_LOGGER) as builder, builder.create_network() as network:
        ...
        with open("custom_plugin.engine", "rb") as f, trt.Runtime(TRT_LOGGER) as runtime:
