...
if __name__ == "__main__":
    ...
    parser.add_argument("-p", "--plugins", nargs="*", default=["/usr/lib/x86_64-linux-gnu/libnvinfer_plugin.so"], help="Path to a plugin (.so) library file. Accepts multiple arguments.")
