...
def main():
    ...
    parser.add_argument("--onnx", required=False, default="/workspace/tensorrt/data/yolov3/export.onnx", help="The ONNX model file to convert to TensorRT")
    ...
    parser.add_argument("--explicit-batch", action='store_true', default=True, help="Set trt.NetworkDefinitionCreationFlag.EXPLICIT_BATCH.")
    ...
    parser.add_argument("--nms", action="store_true", default=True, help="Proceed NMS in TensorRT.")
    ...
    with trt.Builder(TRT_LOGGER) as builder, \
        ...
        if args.nms:
            ...
            input0 = network.get_input(0)
            input1 = network.get_input(1)
            ...
            scores_reshape_op.reshape_dims = [-1, 10647, 3]
            ...
            nms = network.add_plugin_v2(
                    ...
                    plugin=get_trt_plugin("DY_BatchedNMS", plugin_args))
